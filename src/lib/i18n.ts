...
const dict = {
  ...
  "fb.selectTitle": { en: "Select Instagram accounts", ru: "Выберите Instagram-аккаунты" },
  "fb.selectSubtitle": { en: "Choose which accounts to connect", ru: "Выберите, какие аккаунты подключить" },
  "fb.connect": { en: "Connect selected", ru: "Подключить выбранные" },
  "fb.connecting": { en: "Connecting...", ru: "Подключение..." },
  "fb.selectAll": { en: "Select all", ru: "Выбрать все" },
  "fb.expired": { en: "Session expired. Please reconnect via Facebook.", ru: "Сессия истекла. Подключитесь через Facebook заново." },
